...
require "TransformLayer/AE_Position_X.lua"
require "TransformLayer/AE_Position_Y.lua"
...
SolidObject = {
  ...
  TransformLayers = {
    ...
    [TRANSFORM.Position_X] = nil,
    [TRANSFORM.Position_Y] = nil,
    [TRANSFORM.Scale] = nil,
...
function SolidObject:init(scene)
  ...
  positionLayer_x = AE_Position_X:create({})
  positionLayer_x.nodes = {self.transformNode}
  positionLayer_x.COMPOSITION = self.COMPOSITION
  self.TransformLayers[TRANSFORM.Position_X] = positionLayer_x

  positionLayer_y = AE_Position_Y:create({})
  positionLayer_y.nodes = {self.transformNode}
  positionLayer_y.COMPOSITION = self.COMPOSITION
  self.TransformLayers[TRANSFORM.Position_Y] = positionLayer_y
