...
uniform float u_postPosition_x;
uniform float u_postPosition_y;
...
void main(){
    ...
    newTex -= vec2(u_position_x, u_position_y);
    ...
    if(u_motionBlur == true) {
        postTex -= vec2(u_postPosition_x, u_postPosition_y);
